...
$pathStr = explode('/', $uri->getPath());
$pathArr = array_diff($pathStr, ['']) ?: [];
$lastElem = end($pathArr);
...
if (strpos($lastElem, 'page-') !== false && (int) str_replace('page-','', $lastElem)) {
    $pagen = (int) str_replace('page-','', $lastElem);
    $GLOBALS['PAGEN_1'] = $_REQUEST['PAGEN_1'] = $_GET['PAGEN_1'] = $pagen;
}
